			...
			{/* <div className="columns columns--icons">
				<div className="child">
					...
					<ul className="list--plain">
						...
						<li>
							<svg className="icon--inline" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				<div className="child">
					<svg className="icon--big" viewBox="0 0 490.6 436.9" xmlns="http://www.w3.org/2000/svg">
